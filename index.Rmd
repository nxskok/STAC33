...
- 2020-03-10 11:45: About the data analysis [project:](project.pdf). This is due Friday April 3 at 11:59pm. This is a group project (groups chosen by you of up to and including 6 people). Detais in linked document: basically, choose a data set, do an analysis that answers an "interesting" question about the data set, and write a report on it with introduction, analysis and conclusion.
