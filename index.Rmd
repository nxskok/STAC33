...
In this course, we learn R (and at the end SAS, or not), and how to use this software for data organization and to apply statistical methods that you (mostly) already know. I emphasize the communication of the results. That is to say, you need to *get* the answers, but you also need to be able to *explain to others* what the results mean, and *convince others why* what you have done is sensible.


## News (most recent at the top)

- 2020-04-06 19:15: some [exam supports](https://www.utsc.utoronto.ca/studentaffairs/exam-supports) for you from Student Affairs. 

- 2020-04-05 18:00: The [STAC32 old exams page](http://ritsokiguess.site/STAC32/old_exams.html) now has the Fall 2019 final exam. Remember that we didn't do any SAS this year, so you can ignore anything in there on SAS, or, better yet, work out how to do it in R.

- 2020-04-04 17:40: I have graded the (not very many) projects. The person who handed it in should have a few comments. I copied the group's grade to the other members of the group. Let me know if I have missed you. The project marks are about a mark out of 10 more generous than usual, and are my take on how the work compares with what I would expect from a student in this class (with, this year, 8 being "as expected"; normally that is 7.). If it improves your assignment grade, you will benefit grade-wise from having done the project. I hope you benefitted in other ways too.

- 2002-04-04 10:20: we now have, on Quercus, a Module called Videos with a Page in it containing the lectures that have missing sound currently on WebOption. So you can also watch them there.

- 2020-04-04 09:30: on Weboption, lectures 22 and 24 appear to have no sound. I am getting them to fix this, but meanwhile, here are [lecture 22](https://play.library.utoronto.ca/5279611d6aadfcb81d9247cb35a74e4d) and [lecture 24](https://play.library.utoronto.ca/6699e63bc420365e2695abcb384b3675), and they both have sound, at least at this end.

- 2020-04-03 15:30: I decided to extend the due time of the take-home final to 1:00pm on the 9th. This gives you a little more flexibility in arranging your time. I am not going to extend it any further because I would then create a conflict for any of you that have 2:00pm exams. The exam is designed to take you three hours. If you take longer than that, it's a sign that you don't know the material well enough.
...
- 2020-04-02 11:20: some thoughts about the final exam:
  ...
  - Expect to see mainly material from after the midterm, but you may need ideas from before the midterm.
  - There will be about four questions, intended to take you three hours.
  - The exam will be open on Quercus for 12 hours. That is to say, it will become available on April 8 at 11:59 pm and will be due on April 9 at 12:00 noon.  I am giving you extra time to allow for you being in a different time zone, having Internet problems, etc.
  - Late exams may be subject to a penalty. If you have accommodations from Accessability, your exam is due as many minutes after 12:00 as you have minutes of accommodation. (Such an exam may be indicated as "late" on Quercus, but is on time for me if it is within your accommodation.)
  - there is no longer any requirement to get 50% on this final exam.

- 2020-03-31 17:45: [Thursday's lecture](https://play.library.utoronto.ca/6699e63bc420365e2695abcb384b3675) is now up. This completes the lectures for this semester.

- 2020-03-31 17:40: somebody asked me what happens under the revised grading scheme for those who did not write the midterm. Such people are writing a 65% final (45% + 20%).

- 2020-03-31 09:20: in the poll about changing the grading scheme, there were 203 votes, with 169 in favour and 34 against. So the revised grading scheme goes into operation, with the final worth 20%, the midterm 45%, and the remaining 35% divided between the assignments and the project, 35-0 or 20-15, whichever is better for you. This issue is now closed. Thank you for voting.


- 2020-03-30 21:45: I realized that I forgot to post my [Assignment 7 solutions](a7-c33.pdf).

- 2020-03-30 20:00: here is [Tuesday's lecture](https://play.library.utoronto.ca/663800dfc50c7ee2c569cce1da75b633). This is the first part of Bayesian statistics with Stan. I might record the second part tomorrow so that you have it all.

- 2020-03-26 15:00: I've recorded [today's lecture](https://play.library.utoronto.ca/5279611d6aadfcb81d9247cb35a74e4d) on the bootstrap, which will go up on WebOption shortly. It is only about 30 minutes long. But I figure you deserve a break. We'll see how long the Bayesian stuff takes next week.

- 2020-03-26 09:20: the details of the proposed new grading scheme are [in the survey](https://q.utoronto.ca/courses/135550/quizzes/67076). If you are OK with it, vote Yes; if not, vote No. This is not the time to write to me with arguments. If you don't like the proposal, vote No.

- 2020-03-25 20:30: it seems to me unreasonable to keep the final exam weight at 45%. I would like to reduce it to 20%, and scale everything else up. This is a "change in the methods of evaluation in a course or their relative weights", and so it requires you to vote on it. I am about to post a survey on Quercus, in which I lay out the proposed new scheme. (There are actually two schemes, one with and one without the project, and you automatically get whichever one is better for you.) Please vote Yes or No on this before 11:59pm next Monday.

- 2020-03-21 16:50 edited 2020-03-23 16:30: second half of the [functions lecture](https://play.library.utoronto.ca/abc81fcbb100a9e2bbb9b897b24198b5), recorded today. This will go up on WebOption with the first half, to be Tuesday's lecture. (later edit: it is up.)
Problem 16.1 of [PASIAS](http://ritsokiguess.site/pasias/functions.html#functions) is practice for this. You will notice that Problem 16.2 is the same example as the lecture notes!
